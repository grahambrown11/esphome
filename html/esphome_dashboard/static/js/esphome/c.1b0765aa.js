import{E as t,G as e,T as o,H as i,h as s,b as r,n as a,j as n,s as l,x as c,g as p,I as d,J as h,K as u,L as m,z as _,C as w,t as v,N as g,v as y,O as f,P as b}from"./index-299aa7a6.js";import{g as $}from"./c.5d8c53cb.js";import{o as P,c as S}from"./c.cda224a9.js";import{m as k,s as x,b as C}from"./c.89b5b598.js";import{o as E}from"./c.abe9eb24.js";class H{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}}class W{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){var t;null!==(t=this.Y)&&void 0!==t||(this.Y=new Promise((t=>this.Z=t)))}resume(){var t;null===(t=this.Z)||void 0===t||t.call(this),this.Y=this.Z=void 0}}const I=t=>!i(t)&&"function"==typeof t.then,j=1073741823;const A=t(class extends e{constructor(){super(...arguments),this._$C_t=j,this._$Cwt=[],this._$Cq=new H(this),this._$CK=new W}render(...t){var e;return null!==(e=t.find((t=>!I(t))))&&void 0!==e?e:o}update(t,e){const i=this._$Cwt;let s=i.length;this._$Cwt=e;const r=this._$Cq,a=this._$CK;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$C_t);t++){const o=e[t];if(!I(o))return this._$C_t=t,o;t<s&&o===i[t]||(this._$C_t=j,s=0,Promise.resolve(o).then((async t=>{for(;a.get();)await a.get();const e=r.deref();if(void 0!==e){const i=e._$Cwt.indexOf(o);i>-1&&i<e._$C_t&&(e._$C_t=i,e.setValue(t))}})))}return o}disconnected(){this._$Cq.disconnect(),this._$CK.pause()}reconnected(){this._$Cq.reconnect(this),this._$CK.resume()}}),T=async(t,e)=>{import("./c.5ee49bef.js");let o=t.port;if(o)await o.close();else try{o=await navigator.serial.requestPort()}catch(o){return void("NotFoundError"===o.name?P((()=>T(t,e))):alert(`Unable to connect: ${o.message}`))}const i=S(o);e&&e();const s=document.createElement("esphome-install-web-dialog");s.params=t,s.esploader=i,document.body.append(s)},B={info:d,warning:h,error:u,success:m};let D=class extends l{constructor(){super(...arguments),this.title="",this.alertType="info",this.rtl=!1}render(){return c`
      <div
...
//# sourceMappingURL=c.1b0765aa.js.map
